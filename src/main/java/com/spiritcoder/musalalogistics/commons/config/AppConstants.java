...
public class AppConstants {
    ...
    public static final String DRONE_NEW_ACTIVATION_PROCESS_ENABLED = "drone.new.activate.enabled";
    ...
    public static final String EMAIL_ALREADY_EXISTS = "user with email already exists";
