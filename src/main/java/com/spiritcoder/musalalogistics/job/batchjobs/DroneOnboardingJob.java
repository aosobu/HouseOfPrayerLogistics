...
public class DroneOnboardingJob implements Job {
    ...
    private void onboardNewDrones(List<Drone> inactiveDrones) {
        ...
        try{
                ...
                inactiveDrones.forEach(drone -> {
                    ...
                    boolean insertDroneStateSnapshotStatus = droneManager.addDroneToDroneStateSnapshot(drone.getId(), StateEnum.IDLE.name());
                    boolean updateActivationState = droneManager.updateActivationStatus(true, drone.getId());
                    boolean insertDroneBatterySnapshotStatus = droneManager.addDroneToDroneBatterySnapshot(generateBatteryLevel(), drone.getId());
    ...
    private int generateBatteryLevel() {
